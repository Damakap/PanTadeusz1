...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        <div class="container">
            <h1 class="mt-4 text-center text-white">Pan Tadeusz, czyli ostatni zajazd na Litwie: historia szlachecka z roku 1811 
                i 1812 we dwunastu ksiegach wierszem 12</h1>
        </div>
    </nav>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-3 ">
				...
				<a href="./" class="list-group-item list-group-item-action"><i class="bi bi-house-fill"></i> Strona glowna</a>
                    <a href="#" class="list-group-item list-group-item-action disabled" aria-disabled="true">Spis tresci</a>
    ...
    <footer class="text-center mt-4">
        <div class="container">
            <span class="text-muted font-weight-bold">Ksiegi Pan Tadeusz | Autor: Damian Karpiel | Uczelnia: ANS Nowy Targ</span>
        </div>
    </footer>
